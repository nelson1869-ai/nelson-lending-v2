      ...
      InterceptorsWrapper(
        ...
        onError: (DioException error, handler) async {
          if (error.response?.statusCode == 401 &&
              !error.requestOptions.path.contains('/borrower/auth/login') &&
              !error.requestOptions.path.contains('/borrower/auth/refresh') &&
              !error.requestOptions.path.contains('/borrower/auth/activate')) {
