...
on `main`. Nothing is pushed until a later milestone explicitly introduces a remote workflow.
...
- **Deliverables:** Backend package scaffold; configuration; database session foundation; health endpoints; Alembic environment; baseline tests; local setup documentation.
- **Tests / Quality Gates:** Backend import; health tests; pytest; Ruff lint/format; mypy; Alembic single-head check.
