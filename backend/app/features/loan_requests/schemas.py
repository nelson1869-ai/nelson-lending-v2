...
class LoanRequestCreate(LoanRequestBaseSchema):
    ...
    def validate_twice_monthly_first_due_date(self) -> "LoanRequestCreate":
...
class LoanRequestResponse(LoanRequestBaseSchema):
    """Safe loan request data returned to borrower or owner."""
...
class OwnerLoanRequestDetailResponse(LoanRequestResponse):
